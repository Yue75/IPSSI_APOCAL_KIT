      ...
      <div className="space-y-6">
        <section>
          ...
          <p className="text-sm text-slate-700">
            Les présentes conditions générales d’utilisation régissent l’accès et l’usage d’EduTutor
            IA, service de génération de quiz de révision à partir de cours fournis par
            l’utilisateur.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-sm text-slate-700">
            L’utilisateur s’engage à ne téléverser que des contenus dont il détient les droits ou
            pour lesquels il dispose d’une autorisation suffisante.
          </p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-900 mb-1">4. Contenu généré par IA</h2>
          <p className="text-sm text-slate-700">
            Les quiz sont générés automatiquement par une intelligence artificielle et peuvent
            comporter des erreurs. Ils constituent une aide à la révision et ne remplacent pas les
            supports officiels, les enseignants ou le jugement de l’utilisateur.
          </p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-slate-900 mb-1">5. Limite de responsabilité</h2>
          <p className="text-sm text-slate-700">
            EduTutor IA met en œuvre des mesures raisonnables pour fournir un service fiable,
            sécurisé et utile pédagogiquement. Toutefois, l’utilisateur reste responsable de l’usage
            des quiz générés et de la vérification de leur exactitude.
          </p>
        </section>
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-900 mb-1">7. Propriété intellectuelle</h2>
          <p className="text-sm text-slate-700">
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-900 mb-1">8. Droit applicable</h2>
          <p className="text-sm text-slate-700">
