      ...
      <div className="space-y-6">
        <section>
          ...
          <p className="text-sm text-slate-700">
            EduTutor IA est une SAS au capital de 1 000 €, immatriculée au RCS de Paris sous le n°
            912 345 678.
          </p>
        ...
        <section>
          ...
          <p className="text-sm text-slate-700">
            Le service et ses données sont hébergés par OVHcloud, 2 rue Kellermann, 59100 Roubaix,
            France, au sein de l’Union européenne.
          </p>
          <p className="text-sm text-slate-700 mt-2">
            Le traitement par intelligence artificielle est réalisé localement via Ollama : aucune
            donnée n’est transmise à un fournisseur tiers ni transférée hors Union européenne.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-sm text-slate-700">
            Les cours téléversés restent la propriété de leurs auteurs. EduTutor IA ne revendique
            aucun droit sur les supports fournis par les utilisateurs.
          </p>
          <p className="text-sm text-slate-700 mt-2">
